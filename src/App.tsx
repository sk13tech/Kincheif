...
type Page = 'home' | 'shop' | 'about' | 'contact' | 'product' | 'checkout' | 'order-success' | 'orders' | 'privacy' | 'terms' | 'profile';

const validPages: Page[] = ['home', 'shop', 'about', 'contact', 'orders', 'privacy', 'terms', 'profile'];
...
function AppContent() {
  ...
  const showHeader = page !== 'order-success';
  ...
  return (
    <div className="min-h-screen bg-sand-50">
      ...
      {page === 'home' && (<><HeroSection onShopNow={() => go('shop')} /><ProductGrid onViewProduct={viewProduct} /><AboutSection /><InstagramReels /></>)}
