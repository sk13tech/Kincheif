...
export default function Footer({ onNavigate }: Props) {
  ...
  const brand = cfg.siteName || 'PureHome';
  ...
  const sections = [
    { title: 'Shop', links: [
      ...
      { label: 'Pickles & Chutneys', action: 'shop' },
      { label: 'Jams & Preserves', action: 'shop' },
      { label: 'Spices & Masalas', action: 'shop' },
      { label: 'Pure Honey', action: 'shop' },
      { label: 'Healthy Snacks', action: 'shop' },
      { label: 'Beverages', action: 'shop' },
    ]},
