...
export default function Header({ onNavigate, currentPage, onSearch }: HeaderProps) {
  ...
  const logoIcon = siteCfg.logoUrl || '/images/logo.png';
  const logoFull = siteCfg.logoTextUrl || '/images/logo-text.png';
  const siteName = siteCfg.siteName || 'PureHome';
