...
function SiteConfig() {
  ...
  return (
    <div className="max-w-2xl space-y-5">
      ...
      {/* Instagram Reels */}
      <div className={`${card} p-6 space-y-3`}><p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Instagram Reels</p>
        <p className="text-xs text-slate-400 -mt-2">Add Instagram reel URLs. Shown on homepage.</p>
        <textarea value={cfg.instagramReels || ''} onChange={e => setCfg({ ...cfg, instagramReels: e.target.value })} rows={4} className={`${input} resize-none font-mono text-xs`} placeholder="https://instagram.com/reel/abc123&#10;https://instagram.com/reel/def456" />
      </div>
