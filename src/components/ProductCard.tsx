...
export default function ProductCard({ product, index, onViewProduct }: Props) {
  ...
  return (
    <motion.div
      ...
      className="group flex flex-col rounded-lg border border-sand-200 bg-white overflow-hidden cursor-pointer transition-all duration-200 hover:border-sand-400 hover:shadow-md hover:shadow-ink-900/5"
    >
      {/* Image */}
